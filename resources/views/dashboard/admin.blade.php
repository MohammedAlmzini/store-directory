...
<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">لوحة تحكم المشرف</h1>
    </div>
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">المتاجر قيد الانتظار</h6>
                </div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                            @foreach(\App\Models\Store::where('status', 'pending')->take(5)->get() as $store)
                                <tr>
                                    <td>{{ $store->name }}</td>
                                    <td>{{ $store->user->name }}</td>
                                    <td>{{ $store->created_at->format('Y-m-d') }}</td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-success">قبول</a>
